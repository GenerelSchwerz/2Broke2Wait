...
export class TwoBAntiAFKPlugin extends ProxyServerPlugin<TwoBAntiAFKOpts, TwoBAntiAFKEvents<TwoBAntiAFKOpts>> {
   ...
   * @returns
   */
  onOptionValidation = (psOpts: TwoBAntiAFKOpts, bot: Bot): TwoBAntiAFKOpts => {
  ...
  onBotStartup = (bot: Bot, psOpts: TwoBAntiAFKOpts) => {
  ...
  onBotShutdown = (bot: Bot, psOpts: TwoBAntiAFKOpts) => {
