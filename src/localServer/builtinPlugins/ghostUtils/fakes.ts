...
class FakeEntity {
  ...
  public syncToEntity(entity: Entity, PrisItem: typeof ItemType) {
    ...
    this.offHand = PrisItem.toNotch(entity.equipment[6]);
  }
}
...
export class NewFakePlayer {
    ...
    constructor(bot: Bot, opts: Partial<NewFakePlayerOpts>) {
        ...
        this.linkedBot = bot;
        this.entityRef = new FakeEntity(bot.entity.position.clone(), bot.entity.yaw, bot.entity.pitch);
    ...
    public onLinkedMove = (pos: Vec3) => {
        this.entityRef.knownPosition.set(pos.x, pos.y, pos.z);
    ...
    public link(client: AllowedClient) {
